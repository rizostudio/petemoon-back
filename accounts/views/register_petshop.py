...
from accounts.functions import apply_stage, check_petshop_register_stage
...
class RegisterPetshop(APIView):
    ...
    def patch(self, *args, **kwargs):
        ...
        if user.is_registered and stage < 3:
